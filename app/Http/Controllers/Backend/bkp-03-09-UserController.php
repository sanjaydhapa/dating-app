...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('thambnail')) {
            $path = $request->file('thambnail')->store('profile_photos', 'public');  // saved to storage/app/public/profile_photos
            $thumb_url = $path;  // for use in asset($thumb_url)
        }
        User::insert([
            'name' => $request->name,
            'nick_name' => $request->nick_name,
            'email' => $request->email,
            'profile_photo_path' => $thumb_url ?? null,
    ...
    public function update(Request $request)
    {
        ...
        $profileData = $request->only([
            ...
            'partner_financial_status', 'partner_dress_style', 'partner_vaccinated',
            'occupation', 'partner_drinking_habits'
        ]);
        ...
        $arrayFields = [
            ...
            'iam_seeking', 'partner_pets', 'partner_sports', 'partner_entertainment'
        ];
