                            ...
                            <div class="row"> <!-- start 7th row  -->
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <h5>Description </h5>
                                        <div class="controls">
                                            <textarea name="description" id="textarea1" class="form-control textarea1 " placeholder="Textarea text" >{{ old('description') }}</textarea>
                                        </div>
                                    </div>
                                </div> <!-- end col md 6 -->
                            </div> <!-- end 7th row  -->
                            <div class="row"> <!-- start 7th row  -->
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <h5>Content </h5>
                                        <div class="controls">
                                            <textarea name="content" id="textarea" class="form-control textarea " placeholder="Textarea text" >{{ old('content') }}</textarea>
                                        </div>
                                    </div>
                                </div> <!-- end col md 6 -->
                            </div> <!-- end 7th row  -->
                            ...
                            <div class="row"> <!-- start 7th row  -->
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <h5>Css </h5>
                                        <div class="controls">
                                            <textarea name="css" id="textarea" class="form-control textarea " placeholder="Textarea text" >{{ old('content') }}</textarea>
                                        </div>
                                    </div>
                                </div> <!-- end col md 6 -->
                            </div> <!-- end 7th row  -->
                            ...
                            <div class="row"> <!-- start 7th row  -->
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <h5>Script </h5>
                                        <div class="controls">
                                            <textarea name="js" id="textarea" class="form-control textarea " placeholder="Textarea text" >{{ old('content') }}</textarea>
                                        </div>
                                    </div>
                                </div> <!-- end col md 6 -->
                            </div> <!-- end 7th row  -->
