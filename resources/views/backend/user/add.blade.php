                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="content" role="tabpanel">
                                ...
                                <div class="row"> <!-- start 1nd row  -->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <textarea name="love_goals" class="form-control" rows="4"
                                                          placeholder="Describe your life goals..."></textarea>
                                                @error('love_goals')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu p-3"
                                                         style="width: 100%; max-height: 300px; overflow-y: auto;">
                                                        @foreach (config('profile_fields.goals_and_dreams') as $goal)
                                                            <div class="form-check">
                                                                <input type="checkbox" class="form-check-input"
                                                                       id="goals_and_dreams_profile_{{ $loop->index }}"
                                                                       name="goals_and_dreams[]" value="{{ $goal }}">
                                                                <label class="form-check-label"
                                    ...
                                    @php
                                        $selectedPartnerZodiacSign = old('partner_zodiac_sign') ?? [];
                                        if (is_string($selectedPartnerZodiacSign)) {
                                            $selectedPartnerZodiacSign = array_map(
                                                'trim',
                                                explode(',', $selectedPartnerZodiacSign),
                                            );
                                        }
                                    @endphp
                                    <div class="col-md-6 col-sm-6">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (goalsAndDreamsProfileCheckboxes.length > 0) {
                ...
                updateGoalsAndDreamsProfileButton();
            }
            ...
            if (partnerGoalsAndDreamsCheckboxes.length > 0) {
                ...
                updatePartnerGoalsAndDreamsButton();
            }
        });
    </script>
@endsection
