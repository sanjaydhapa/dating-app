        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">	
			<a href="#" class="waves-effect waves-light rounded dropdown-toggle p-0" data-toggle="dropdown" title="User">
				<img src="{{ (!empty($adminData->profile_photo_path))?url('uploads/admin_images/'.$adminData->profile_photo_path): url('uploads/no_image.jpg')}}" alt="">
			</a>
			<ul class="dropdown-menu animated flipInX">
			  <li class="user-body">
				 ...
				 <a class="dropdown-item" href="{{ route('view.setting')}}"><i class="ti-settings text-muted mr-2"></i> Settings</a>
		  ...
		  <li>
              <a href="{{ route('view.setting')}}" data-toggle="control-sidebar" title="Setting" class="waves-effect waves-light">
